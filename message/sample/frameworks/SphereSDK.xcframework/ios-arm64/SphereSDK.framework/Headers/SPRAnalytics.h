...
+ (void)setName:(nullable NSString *)userName;
...
+ (void) login :(nullable NSString *) userId userInfo:(nullable SPRUserBuilder *) userInfo isSendEvent: (BOOL)isSendEvent;

+ (void) logout ;

+ (void) profileUpdate :(NSString *) userId userInfo:(nullable SPRUserBuilder *) userInfo isSendEvent: (BOOL)isSendEvent;

+ (void) setEventSendingInterval : (long) interval;
